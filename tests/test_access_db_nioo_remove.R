...
if (dir.exists(paste(dir, "/NIOO_NetherlandsInstituteOfEcology_Netherlands", sep = ""))) {
    print("Directory exists!")
    dir <- paste0(dir, "/NIOO_NetherlandsInstituteOfEcology_Netherlands")
} else {
    print("Directory does not exist.")
}

dsn <- paste0(dir, "/NIOO_PrimaryData.accdb")
...
nioo_python <- format_NIOO_python(
    db = dir,
    species = NULL,
    pop = NULL,
...
nioo_rjackcess <- format_NIOO_rjackcess(
    db = dir,
    species = NULL,
    pop = NULL,
    path = ".", # Not needed, since we save to an R object
