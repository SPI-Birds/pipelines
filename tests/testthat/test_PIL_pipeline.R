...
test_that("Brood_data returns an expected outcome...", {
  ...
  expect_equal(subset(PIL_data, BroodID == "2010_16_25_13")$LayDate, as.Date("2010-04-13"))
  expect_equal(subset(PIL_data, BroodID == "2010_16_25_13")$ClutchSize, 10L)
  expect_equal(subset(PIL_data, BroodID == "2010_16_25_13")$BroodSize, 10L)
  expect_equal(subset(PIL_data, BroodID == "2010_16_25_13")$NumberFledged, 10L)
  ...
  expect_equal(subset(PIL_data, BroodID == "2000_7_90_40")$LayDate, as.Date("2000-05-10"))
  expect_equal(subset(PIL_data, BroodID == "2000_7_90_40")$ClutchSize, 5L)
  expect_equal(subset(PIL_data, BroodID == "2000_7_90_40")$BroodSize, 5L)
  expect_equal(subset(PIL_data, BroodID == "2000_7_90_40")$NumberFledged, 3L)
  ...
  expect_equal(subset(PIL_data, BroodID == "2006_6_51_58")$LayDate, as.Date("2006-05-28"))
  expect_equal(subset(PIL_data, BroodID == "2006_6_51_58")$ClutchSize, 10L)
  expect_equal(subset(PIL_data, BroodID == "2006_6_51_58")$BroodSize, NA_integer_)
  expect_equal(subset(PIL_data, BroodID == "2006_6_51_58")$NumberFledged, 5L)
  ...
  expect_equal(subset(PIL_data, BroodID == "2017_2_243_45")$LayDate, as.Date("2017-05-15"))
  expect_equal(subset(PIL_data, BroodID == "2017_2_243_45")$ClutchSize, 7L)
  expect_equal(subset(PIL_data, BroodID == "2017_2_243_45")$BroodSize, 7L)
  expect_equal(subset(PIL_data, BroodID == "2017_2_243_45")$NumberFledged, 7L)
...
test_that("Individual data returns an expected outcome...", {
  ...
  expect_equal(subset(PIL_data, IndvID == "3E3832")$Sex, "F")
  ...
  expect_equal(subset(PIL_data, IndvID == "1E6750")$Sex, "F")
