...
test_that("Capture_data returns an expected outcome...", {
  ...
  CHO_data <- dplyr::filter(pipeline_output$Capture_data, captureSiteID == "CHO")
  ...
  expect_equal(dplyr::first(subset(CHO_data, individualID == paste0("CHO_", "C044309"))$captureRingNumber), NA_character_)
  expect_equal(dplyr::first(subset(CHO_data, individualID == paste0("CHO_", "C044309"))$releaseRingNumber), "C044309")
  #Test that the 5th capture of the female is as expected (2006-06-24)
  expect_equal(dplyr::last(subset(CHO_data, individualID == paste0("CHO_", "C044309"))$captureYear), 2006)
  expect_equal(dplyr::last(subset(CHO_data, individualID == paste0("CHO_", "C044309"))$captureMonth), 6)
  expect_equal(dplyr::last(subset(CHO_data, individualID == paste0("CHO_", "C044309"))$captureDay), 24)
  expect_equal(dplyr::last(subset(CHO_data, individualID == paste0("CHO_", "C044309"))$captureRingNumber), "C044309")
  expect_equal(dplyr::last(subset(CHO_data, individualID == paste0("CHO_", "C044309"))$releaseRingNumber), "C044309")
  ...
  expect_equal(dplyr::last(subset(CHO_data, individualID == paste0("CHO_", "C044309"))$minimumAge), 4)
  ...
  expect_equal(dplyr::first(subset(CHO_data, individualID == paste0("CHO_", "C029843"))$captureRingNumber), NA_character_)
  expect_equal(dplyr::first(subset(CHO_data, individualID == paste0("CHO_", "C029843"))$releaseRingNumber), "C029843")
  #Test that the 2nd capture of the male is as expcted (2003-10-17)
  expect_equal(dplyr::last(subset(CHO_data, individualID == paste0("CHO_", "C029843"))$captureYear), 2003)
  expect_equal(dplyr::last(subset(CHO_data, individualID == paste0("CHO_", "C029843"))$captureMonth), 10)
  expect_equal(dplyr::last(subset(CHO_data, individualID == paste0("CHO_", "C029843"))$captureDay), 17)
  expect_equal(dplyr::last(subset(CHO_data, individualID == paste0("CHO_", "C029843"))$captureRingNumber), "C029843")
  expect_equal(dplyr::last(subset(CHO_data, individualID == paste0("CHO_", "C029843"))$releaseRingNumber), "C029843")
  ...
  expect_equal(dplyr::last(subset(CHO_data, individualID == paste0("CHO_", "C029843"))$minimumAge), 1)
  ...
  expect_equal(dplyr::first(subset(CHO_data, individualID == paste0("CHO_", "C048092"))$captureRingNumber), NA_character_)
  expect_equal(dplyr::first(subset(CHO_data, individualID == paste0("CHO_", "C048092"))$releaseRingNumber), "C048092")
  ...
  expect_equal(dplyr::last(subset(CHO_data, individualID == paste0("CHO_", "C048092"))$captureYear), 2006)
  expect_equal(dplyr::last(subset(CHO_data, individualID == paste0("CHO_", "C048092"))$captureMonth), 7)
  expect_equal(dplyr::last(subset(CHO_data, individualID == paste0("CHO_", "C048092"))$captureDay), 1)
  expect_equal(dplyr::last(subset(CHO_data, individualID == paste0("CHO_", "C048092"))$captureRingNumber), "C048092")
  expect_equal(dplyr::last(subset(CHO_data, individualID == paste0("CHO_", "C048092"))$releaseRingNumber), "C048092")
  expect_equal(dplyr::last(subset(CHO_data, individualID == paste0("CHO_", "C048092"))$chickAge), NA_integer_)
  ...
  expect_equal(dplyr::last(subset(CHO_data, individualID == paste0("CHO_", "C048092"))$exactAge), 1)
  ...
  expect_equal(dplyr::nth(subset(CHO_data, individualID == paste0("CHO_", "C048092"))$minimumAge, n = 2), 0)
  #Test that age calculated is correct on 4th capture (1, because it was caught as chick in the previous year)
  expect_equal(dplyr::last(subset(CHO_data, individualID == paste0("CHO_", "C048092"))$minimumAge), 1)
...
test_that("Measurement_data returns an expected outcome...", {
  ...
  CHO_data <- dplyr::filter(pipeline_output$Measurement_data, siteID == "CHO")
...
test_that("Location_data returns an expected outcome...", {
  ...
  CHO_data <- dplyr::filter(pipeline_output$Location_data, siteID == "CHO")
