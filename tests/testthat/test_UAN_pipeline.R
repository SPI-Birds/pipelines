# context("Run data quality check on University of Amsterdam pipeline output")
#
# test_that("UAN outputs all files...", {
#
#   expect_true(c("PEE", "BOS") %in% pipeline_output$Brood_data$PopID)
#   expect_true(c("PEE", "BOS") %in% pipeline_output$Capture_data$CapturePopID)
#   expect_true(c("PEE", "BOS") %in% pipeline_output$Individual_data$PopID)
#   expect_true(c("PEE", "BOS") %in% pipeline_output$Location_data$PopID)
#
# })
#
...
#
#   #Test 1: Adult female
#   #Individual JA39911 should be listed as a female great tit
#   expect_equal(subset(UAN_data, IndvID == "JA39911")$Sex, "F")
#   expect_equal(subset(UAN_data, IndvID == "JA39911")$Species, "PARMAJ")
#   #Check BroodIDLaid and Fledged are as expected
#   #NA because only caught as adult
#   expect_equal(subset(UAN_data, IndvID == "JA39911")$BroodIDLaid, NA_character_)
#   expect_equal(subset(UAN_data, IndvID == "JA39911")$BroodIDFledged, NA_character_)
#   #Check ring season and age are as expected
#   expect_equal(subset(UAN_data, IndvID == "JA39911")$RingSeason, 2014)
#   expect_equal(subset(UAN_data, IndvID == "JA39911")$RingAge, "adult")
#
#   #Test 2: Adult male
#   #Individual D534573 should be listed as a female great tit
#   expect_equal(subset(UAN_data, IndvID == "D534573")$Sex, "F")
#   expect_equal(subset(UAN_data, IndvID == "D534573")$Species, "PARMAJ")
#   #She should have no BroodIDLaid or Fledged because there is no chick info
#   expect_equal(subset(UAN_data, IndvID == "D534573")$BroodIDLaid, NA_character_)
#   expect_equal(subset(UAN_data, IndvID == "D534573")$BroodIDFledged, NA_character_)
#   #Her ring season should be 2011 with a RingAge of 'chick'
#   expect_equal(subset(UAN_data, IndvID == "D534573")$RingSeason, 2013)
#   expect_equal(subset(UAN_data, IndvID == "D534573")$RingAge, "adult")
#
#   #Test 3: Adult blue tit male
#   #Individual D534700 should be listed as a male blue tit
#   expect_equal(subset(UAN_data, IndvID == "D534700")$Sex, "M")
#   expect_equal(subset(UAN_data, IndvID == "D534700")$Species, "CYACAE")
#   #She should have no BroodIDLaid or Fledged because there is no chick info
#   expect_equal(subset(UAN_data, IndvID == "D534700")$BroodIDLaid, NA_character_)
#   expect_equal(subset(UAN_data, IndvID == "D534700")$BroodIDFledged, NA_character_)
#   #Her ring season should be 2014 with a RingAge of 'adult'
#   expect_equal(subset(UAN_data, IndvID == "D534700")$RingSeason, 2014)
#   expect_equal(subset(UAN_data, IndvID == "D534700")$RingAge, "adult")
#
#   #Test 4: Adult great tit male
#   #Individual D534574 should be listed as a female great tit
#   expect_equal(subset(UAN_data, IndvID == "D534574")$Sex, "M")
#   expect_equal(subset(UAN_data, IndvID == "D534574")$Species, "PARMAJ")
#   #She should have no BroodIDLaid or Fledged because there is no chick info
#   expect_equal(subset(UAN_data, IndvID == "D534574")$BroodIDLaid, NA_character_)
#   expect_equal(subset(UAN_data, IndvID == "D534574")$BroodIDFledged, NA_character_)
#   #Her ring season should be 2011 with a RingAge of 'chick'
#   expect_equal(subset(UAN_data, IndvID == "D534574")$RingSeason, 2013)
#   expect_equal(subset(UAN_data, IndvID == "D534574")$RingAge, "adult")
#
# })
#
...
#   expect_equal(subset(UAN_data, BroodID == "2017_BP_010_16_04")$Species, "PARMAJ")
...
#   expect_equal(subset(UAN_data, BroodID == "2017_BP_010_16_04")$NumberFledged, 4)
#   #AvgChickMass and AvgTarsus should be NA, there were no chicks
#   expect_equal(subset(UAN_data, BroodID == "2017_BP_010_16_04")$AvgChickMass, NA_real_)
#   expect_equal(subset(UAN_data, BroodID == "2017_BP_010_16_04")$AvgTarsus, NA_real_)
#
#   #Test 2: Great tit brood clutch type = second
#   #BroodID 2017_BP_027_13_05 should be PARMAJ
#   expect_equal(subset(UAN_data, BroodID == "2017_BP_027_13_05")$Species, "PARMAJ")
...
#   expect_equal(subset(UAN_data, BroodID == "2017_BP_027_13_05")$NumberFledged, 6)
#   #AvgChickMass and AvgTarsus should be NA, there were no chicks
#   expect_equal(subset(UAN_data, BroodID == "2017_BP_027_13_05")$AvgChickMass, NA_real_)
#   expect_equal(subset(UAN_data, BroodID == "2017_BP_027_13_05")$AvgTarsus, NA_real_)
#
...
#   expect_equal(subset(UAN_data, BroodID == "2015_BC_024_05_06")$Species, "PARMAJ")
...
#   expect_equal(subset(UAN_data, BroodID == "2015_BC_024_05_06")$NumberFledged, 0)
#   #AvgChickMass and AvgTarsus should be NA, there were no chicks
#   expect_equal(subset(UAN_data, BroodID == "2015_BC_024_05_06")$AvgChickMass, NA_real_)
#   expect_equal(subset(UAN_data, BroodID == "2015_BC_024_05_06")$AvgTarsus, NA_real_)
#
...
#   expect_equal(subset(UAN_data, BroodID == "2014_KB_028_14_06")$Species, "PARMAJ")
...
#   expect_equal(subset(UAN_data, BroodID == "2014_KB_028_14_06")$NumberFledged, 2)
#   #AvgChickMass and AvgTarsus should be NA, there were no chicks
#   expect_equal(subset(UAN_data, BroodID == "2014_KB_028_14_06")$AvgChickMass, NA_real_)
#   expect_equal(subset(UAN_data, BroodID == "2014_KB_028_14_06")$AvgTarsus, NA_real_)
#
# })
#
...
#   expect_equal(subset(UAN_data, IndvID == "D534573")$Age_calculated[6], 12L)
#
#   #Test 1: Male caught as adult
#   #Test the male has the correct number of capture records (6)
#   expect_equal(nrow(subset(UAN_data, IndvID == "D534574")), 6)
#   #Test that the first capture of the male is as expected (2013-06-02)
#   expect_equal(min(subset(UAN_data, IndvID == "D534574")$CaptureDate, na.rm = TRUE), as.Date("2013-06-02"))
#   #Test that the 6th capture of the male is as expcted (2018-06-08)
#   expect_equal(subset(UAN_data, IndvID == "D534574")$CaptureDate[6], as.Date("2018-06-08"))
#   #Test that age observed is as expected (NA, because we just know it was caught as an adult, that's all)
#   expect_equal(subset(UAN_data, IndvID == "D534574")$Age_observed[1], NA_integer_)
#   #Test that age calculated is correct on first capture (4 because it's an adult of unknown age)
#   expect_equal(subset(UAN_data, IndvID == "D534574")$Age_calculated[1], 4L)
...
#   expect_equal(subset(UAN_data, IndvID == "D534574")$Age_calculated[6], 14L)
#
# })
#
...
#   expect_equal(subset(UAN_data, LocationID == "BP_001")$LocationType, "NB")
#   #Nest boxes are not moved during the study, so LocationID and NestboxID should be identical
#   expect_equal(subset(UAN_data, LocationID == "BP_001")$LocationID, subset(UAN_data, LocationID == "BP_001")$NestboxID)
#
# })
