...
test_that("Brood_data returns an expected outcome...", {
  ...
  expect_equal(subset(AMM_data, BroodID == "1241")$LayDate_observed, as.Date("2010-05-13"))
  expect_equal(subset(AMM_data, BroodID == "1241")$LayDate_minimum, as.Date("2010-05-08"))
  expect_equal(subset(AMM_data, BroodID == "1241")$LayDate_maximum, as.Date("2010-05-13"))
