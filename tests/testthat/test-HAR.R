...
test_that("HAR outputs all files...", {
  ...
  expect_true("HAR-1" %in% pipeline_output$Brood_data$studyID)
  expect_true("HAR-1" %in% pipeline_output$Capture_data$studyID)
  expect_true("HAR-1" %in% pipeline_output$Individual_data$studyID)
  expect_true("HAR-1" %in% pipeline_output$Measurement_data$studyID)
  expect_true("HAR-1" %in% pipeline_output$Location_data$studyID)
  expect_true("HAR-1" %in% pipeline_output$Experiment_data$studyID)
...
test_that("Brood_data returns an expected outcome...", {
  ...
  HAR_data <- dplyr::filter(pipeline_output$Brood_data, studyID == "HAR-1")
...
test_that("Individual data returns an expected outcome...", {
  ...
  # Take a subset of only HAR data
  HAR_data <- dplyr::filter(pipeline_output$Individual_data, studyID == "HAR-1")
  ...
  # Her tag year should be 1991 with a tagStage of 'adult'
  expect_equal(subset(HAR_data, individualID == paste0("HAR_", "V675839"))$tagYear, 1991L)
  expect_equal(subset(HAR_data, individualID == paste0("HAR_", "V675839"))$tagStage, "adult")
  ...
  # His tag year should be 1991 with a tagStage of 'adult'
  expect_equal(subset(HAR_data, individualID == paste0("HAR_", "HA32954"))$tagYear, 2019)
  expect_equal(subset(HAR_data, individualID == paste0("HAR_", "HA32954"))$tagStage, "adult")
  ...
  # tagYear should be 2005 with a tagStage of 'chick'
  expect_equal(subset(HAR_data, individualID == paste0("HAR_", "HL010189"))$tagYear, 2005L)
  expect_equal(subset(HAR_data, individualID == paste0("HAR_", "HL010189"))$tagStage, "chick")
  ...
  # tagYear should be 1991 with a tagStage of 'chick'
  expect_equal(subset(HAR_data, individualID == paste0("HAR_", "X127548"))$tagYear, 1991L)
  expect_equal(subset(HAR_data, individualID == paste0("HAR_", "X127548"))$tagStage, "chick")
...
test_that("Capture data returns an expected outcome...", {
  ...
  # Take a subset of only HAR data
  HAR_data <- dplyr::filter(pipeline_output$Capture_data, studyID == "HAR-1")
  ...
  expect_equal(dplyr::first(subset(HAR_data, individualID == paste0("HAR_", "X341048"))$captureTagID), NA_character_)
  expect_equal(dplyr::first(subset(HAR_data, individualID == paste0("HAR_", "X341048"))$releaseTagID), "X341048")
  ...
  expect_equal(dplyr::nth(subset(HAR_data, individualID == paste0("HAR_", "X341048"))$captureTagID, 12), "X341048")
  expect_equal(dplyr::nth(subset(HAR_data, individualID == paste0("HAR_", "X341048"))$releaseTagID, 12), "X341048")
  ...
  expect_equal(dplyr::first(subset(HAR_data, individualID == paste0("HAR_", "V871926"))$captureTagID), NA_character_)
  expect_equal(dplyr::first(subset(HAR_data, individualID == paste0("HAR_", "V871926"))$releaseTagID), "V871926")
  ...
  expect_equal(dplyr::nth(subset(HAR_data, individualID == paste0("HAR_", "V871926"))$captureTagID, 5), "V871926")
  expect_equal(dplyr::nth(subset(HAR_data, individualID == paste0("HAR_", "V871926"))$releaseTagID, 5), "V871926")
  ...
  # Test that exactAge (and minimumAge) on the 5th capture is as expected (1, because it's a chick caught just under 2 years after birth)
  expect_equal(dplyr::nth(subset(HAR_data, individualID == paste0("HAR_", "V871926"))$exactAge, 5), 1)
  expect_equal(dplyr::nth(subset(HAR_data, individualID == paste0("HAR_", "V871926"))$minimumAge, 5), 1)
  ...
  expect_equal(dplyr::first(subset(HAR_data, individualID == paste0("HAR_", "X620030"))$captureTagID), NA_character_)
  expect_equal(dplyr::first(subset(HAR_data, individualID == paste0("HAR_", "X620030"))$releaseTagID), "X620030")
  ...
  expect_equal(dplyr::nth(subset(HAR_data, individualID == paste0("HAR_", "X620030"))$captureTagID, 2), "X620030")
  expect_equal(dplyr::nth(subset(HAR_data, individualID == paste0("HAR_", "X620030"))$releaseTagID, 2), "X620030")
  # Test that exactAge (and minimumAge) on the 1st capture is as expected (0, because it's caught as a chick)
  ...
  expect_equal(dplyr::first(subset(HAR_data, individualID == paste0("HAR_", "X126587"))$captureTagID), NA_character_)
  expect_equal(dplyr::first(subset(HAR_data, individualID == paste0("HAR_", "X126587"))$releaseTagID), "X126587")
  ...
  expect_equal(dplyr::nth(subset(HAR_data, individualID == paste0("HAR_", "X126587"))$captureTagID, 11), "X126587")
  expect_equal(dplyr::nth(subset(HAR_data, individualID == paste0("HAR_", "X126587"))$releaseTagID, 11), "X126587")
  # Test that exactAge (and minimumAge) on the 1st capture is as expected (0, because it's caught as a chick)
  ...
  expect_equal(dplyr::first(subset(HAR_data, individualID == paste0("HAR_", "HL010189"))$captureTagID), NA_character_)
  expect_equal(dplyr::first(subset(HAR_data, individualID == paste0("HAR_", "HL010189"))$releaseTagID), "HL010189")
  ...
  expect_equal(dplyr::nth(subset(HAR_data, individualID == paste0("HAR_", "HL010189"))$captureTagID, 3), "HL010189")
  expect_equal(dplyr::nth(subset(HAR_data, individualID == paste0("HAR_", "HL010189"))$releaseTagID, 3), "HL010189")
  # Test that exactAge (and minimumAge) on the 1st capture is as expected (0, because it's caught as a chick)
  # TODO: Let calc_age calculate age when only captureYear is known
  ...
  expect_equal(dplyr::first(subset(HAR_data, individualID == paste0("HAR_", "V675839"))$captureTagID), NA_character_)
  expect_equal(dplyr::first(subset(HAR_data, individualID == paste0("HAR_", "V675839"))$releaseTagID), "V675839")
  ...
  expect_equal(dplyr::first(subset(HAR_data, individualID == paste0("HAR_", "X103679"))$captureTagID), NA_character_)
  expect_equal(dplyr::first(subset(HAR_data, individualID == paste0("HAR_", "X103679"))$releaseTagID), "X103679")
  ...
  expect_equal(dplyr::nth(subset(HAR_data, individualID == paste0("HAR_", "X103679"))$captureTagID, 9), "X103679")
  expect_equal(dplyr::nth(subset(HAR_data, individualID == paste0("HAR_", "X103679"))$releaseTagID, 9), "X103679")
  ...
  expect_equal(dplyr::first(subset(HAR_data, individualID == paste0("HAR_", "X103582"))$captureTagID), NA_character_)
  expect_equal(dplyr::first(subset(HAR_data, individualID == paste0("HAR_", "X103582"))$releaseTagID), "X103582")
  # Test that exactAge is as expected (NA, because it's ringed as an adult)
...
test_that("Measurement_data returns an expected outcome...", {
  ...
  HAR_data <- dplyr::filter(pipeline_output$Measurement_data, studyID == "HAR-1")
...
test_that("Location_data returns an expected outcome...", {
  ...
  # Take a subset of HAR data
  HAR_data <- dplyr::filter(pipeline_output$Location_data, studyID == "HAR-1")
...
test_that("Experiment_data returns an expected outcome...", {
  ...
  # Take a subset of HAR data
  HAR_data <- dplyr::filter(pipeline_output$Experiment_data, studyID == "HAR-1")
  ...
  expect_equal(subset(HAR_data, experimentID == "1994_1")$treatmentStartYear, rep(1994, 3))
  expect_equal(subset(HAR_data, experimentID == "1994_1")$treatmentStartMonth, rep(5, 3))
  expect_equal(subset(HAR_data, experimentID == "1994_1")$treatmentStartDay, rep(29, 3))
  expect_equal(subset(HAR_data, experimentID == "1994_1")$treatmentEndYear, rep(1994, 3))
  ...
  expect_equal(subset(HAR_data, experimentID == "1994_1")$treatmentStage, rep("nestling", 3))
