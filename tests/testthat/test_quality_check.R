...
test_that("Single checks function as expected...", {
  ...
  # Test check B14
  expect_equal(subset(dummy_check$R_data$Brood_data, CheckID == "B14")$Warning, c(NA, NA))
  expect_equal(subset(dummy_check$R_data$Brood_data, CheckID == "B14")$Error, c(NA, TRUE))
