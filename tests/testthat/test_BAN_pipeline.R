...
#
#   check <- check_format_individual(BAN_data)
#
...
#   check <- compare_clutch_brood(BAN_data)
#
#   expect_false(check$check_list$Error)
#
#   if(check$check_list$Error == TRUE){
...
#   check <- compare_brood_fledglings(BAN_data)
#
#   expect_false(check$check_list$Error)
#
#   if(check$check_list$Error == TRUE){
...
#   check <- compare_laying_hatching(BAN_data)
#
#   expect_false(check$check_list$Error)
#
#   if(check$check_list$Error == TRUE){
...
#   check <- compare_hatching_fledging(BAN_data)
#
#   expect_false(check$check_list$Error)
#
#   if(check$check_list$Error == TRUE){
