...
test_that("Individual data returns an expected outcome...", {
  ...
  expect_equal(subset(VEL_data, IndvID == "n550440")$Sex_calculated, "F")
  ...
  expect_equal(subset(VEL_data, IndvID == "s754396")$Sex_calculated, "F")
  expect_equal(subset(VEL_data, IndvID == "s754396")$Species, "FICALB")
  #She should have same BroodIDLaid and Fledged (2016_089_05_05)
  expect_equal(subset(VEL_data, IndvID == "s754396")$BroodIDLaid, "2016_zmola_089_05_05")
  expect_equal(subset(VEL_data, IndvID == "s754396")$BroodIDFledged, "2016_zmola_089_05_05")
  ...
  expect_equal(subset(VEL_data, IndvID == "s754714")$Sex_calculated, "M")
  expect_equal(subset(VEL_data, IndvID == "s754714")$Species, "FICALB")
  #He should have same BroodIDLaid and Fledged (2016_036_11_05)
  expect_equal(subset(VEL_data, IndvID == "s754714")$BroodIDLaid, "2016_zmola_036_11_05")
  expect_equal(subset(VEL_data, IndvID == "s754714")$BroodIDFledged, "2016_zmola_036_11_05")
  ...
  expect_equal(subset(VEL_data, IndvID == "t893658")$Sex_calculated, NA_character_)
  expect_equal(subset(VEL_data, IndvID == "t893658")$Species, "FICALB")
  #Check BroodIDLaid and Fledged are the same (1998_041_10_05)
  expect_equal(subset(VEL_data, IndvID == "t893658")$BroodIDLaid, "1998_jedna_041_10_05")
  expect_equal(subset(VEL_data, IndvID == "t893658")$BroodIDFledged, "1998_jedna_041_10_05")
...
test_that("Brood_data returns an expected outcome...", {
  ...
  expect_equal(subset(VEL_data, BroodID == "2001_tri_006_20_04")$Species, "PARMAJ")
  #BroodID 2017_BP_010_16_04 should have clutch type calculated 'first'
  expect_equal(subset(VEL_data, BroodID == "2001_tri_006_20_04")$ClutchType_calculated, "first")
  #Check laying date is as expected (2001-04-20)
  expect_equal(subset(VEL_data, BroodID == "2001_tri_006_20_04")$LayDate_observed, as.Date("2001-04-20"))
  #Check clutch size, brood size, and number fledged is as expected (11, NA, 11)
  expect_equal(subset(VEL_data, BroodID == "2001_tri_006_20_04")$ClutchSize_observed, 11)
  expect_equal(subset(VEL_data, BroodID == "2001_tri_006_20_04")$BroodSize_observed, NA_integer_)
  expect_equal(subset(VEL_data, BroodID == "2001_tri_006_20_04")$NumberFledged_observed, 11)
  #AvgChickMass and AvgTarsus should be NA, there were no chicks measured
  expect_equal(subset(VEL_data, BroodID == "2001_tri_006_20_04")$AvgChickMass, NA_real_)
  expect_equal(subset(VEL_data, BroodID == "2001_tri_006_20_04")$AvgTarsus, NA_real_)

  #Test 2: Tit brood where clutch type = second
  #BroodID 2013_004_14_06 should be PARMAJ
  expect_equal(subset(VEL_data, BroodID == "2013_zmola_004_14_06")$Species, "PARMAJ")
  #BroodID 2013_004_14_06 should have clutch type calculated 'replacement'
  expect_equal(subset(VEL_data, BroodID == "2013_zmola_004_14_06")$ClutchType_calculated, "second")
  #Check laying date is as expected (2013-06-14)
  expect_equal(subset(VEL_data, BroodID == "2013_zmola_004_14_06")$LayDate_observed, as.Date("2013-06-14"))
  #Check clutch size, brood size, and number fledged is as expected (2, NA, NA)
  expect_equal(subset(VEL_data, BroodID == "2013_zmola_004_14_06")$ClutchSize_observed, 2)
  expect_equal(subset(VEL_data, BroodID == "2013_zmola_004_14_06")$BroodSize_observed, NA_integer_)
  expect_equal(subset(VEL_data, BroodID == "2013_zmola_004_14_06")$NumberFledged_observed, NA_integer_)
  #AvgChickMass and AvgTarsus should be NA, there were no chicks measured
  expect_equal(subset(VEL_data, BroodID == "2013_zmola_004_14_06")$AvgChickMass, NA_real_)
  expect_equal(subset(VEL_data, BroodID == "2013_zmola_004_14_06")$AvgTarsus, NA_real_)

  #Test 3: Tit brood where clutch type = replacement (due to past cutoff)
  #BroodID 2013_104_24_06 should be PARMAJ
  expect_equal(subset(VEL_data, BroodID == "2013_sluka_104_24_06")$Species, "PARMAJ")
  #BroodID 2013_004_14_06 should have clutch type calculated 'replacement'
  expect_equal(subset(VEL_data, BroodID == "2013_sluka_104_24_06")$ClutchType_calculated, "replacement")
  #Check laying date is as expected (2013-06-24)
  expect_equal(subset(VEL_data, BroodID == "2013_sluka_104_24_06")$LayDate_observed, as.Date("2013-06-24"))
  #Check clutch size, brood size, and number fledged is as expected (11, NA, 11)
  expect_equal(subset(VEL_data, BroodID == "2013_sluka_104_24_06")$ClutchSize_observed, 11)
  expect_equal(subset(VEL_data, BroodID == "2013_sluka_104_24_06")$BroodSize_observed, NA_integer_)
  expect_equal(subset(VEL_data, BroodID == "2013_sluka_104_24_06")$NumberFledged_observed, 11)
  #AvgChickMass and AvgTarsus should be NA, there were no chicks measured
  expect_equal(subset(VEL_data, BroodID == "2013_sluka_104_24_06")$AvgChickMass, NA_real_)
  expect_equal(subset(VEL_data, BroodID == "2013_sluka_104_24_06")$AvgTarsus, NA_real_)

  #Test 4: Tit brood where clutch type = replacement (due to past cutoff)
  #BroodID 2013_043_27_04 should be PARMAJ
  expect_equal(subset(VEL_data, BroodID == "2013_duby_043_27_04")$Species, "PARMAJ")
  #BroodID 2013_004_14_06 should have clutch type calculated 'replacement'
  expect_equal(subset(VEL_data, BroodID == "2013_duby_043_27_04")$ClutchType_calculated, "second")
  #Check laying date is as expected (2013-04-27)
  expect_equal(subset(VEL_data, BroodID == "2013_duby_043_27_04")$LayDate_observed, as.Date("2013-04-27"))
  #Check clutch size, brood size, and number fledged is as expected (10, NA, 10)
  expect_equal(subset(VEL_data, BroodID == "2013_duby_043_27_04")$ClutchSize_observed, 10)
  expect_equal(subset(VEL_data, BroodID == "2013_duby_043_27_04")$BroodSize_observed, NA_integer_)
  expect_equal(subset(VEL_data, BroodID == "2013_duby_043_27_04")$NumberFledged_observed, 10)
  #AvgChickMass and AvgTarsus should be NA, there were no chicks measured
  expect_equal(subset(VEL_data, BroodID == "2013_duby_043_27_04")$AvgChickMass, NA_real_)
  expect_equal(subset(VEL_data, BroodID == "2013_duby_043_27_04")$AvgTarsus, NA_real_)

  #Test 5: Flycatcher brood where clutch type = first
  #BroodID 2009_053_07_05 should be FICALB
  expect_equal(subset(VEL_data, BroodID == "2009_endy_053_07_05")$Species, "FICALB")
  #BroodID 2017_BP_010_16_04 should have clutch type calculated 'first'
  expect_equal(subset(VEL_data, BroodID == "2009_endy_053_07_05")$ClutchType_calculated, "first")
  #Check laying date is as expected (2009-05-07)
  expect_equal(subset(VEL_data, BroodID == "2009_endy_053_07_05")$LayDate_observed, as.Date("2009-05-07"))
  #Check clutch size, brood size, and number fledged is as expected (11, NA, 11)
  expect_equal(subset(VEL_data, BroodID == "2009_endy_053_07_05")$ClutchSize_observed, 6)
  expect_equal(subset(VEL_data, BroodID == "2009_endy_053_07_05")$BroodSize_observed, 0)
  expect_equal(subset(VEL_data, BroodID == "2009_endy_053_07_05")$NumberFledged_observed, 0)
  #AvgChickMass and AvgTarsus should be NA, there were no chicks measured
  expect_equal(subset(VEL_data, BroodID == "2009_endy_053_07_05")$AvgChickMass, NA_real_)
  expect_equal(subset(VEL_data, BroodID == "2009_endy_053_07_05")$AvgTarsus, NA_real_)
  ...
  expect_equal(subset(VEL_data, BroodID == "2009_endy_035_02_06")$Species, "FICALB")
  #BroodID 2009_035_02_06 should have clutch type calculated 'replacement'
  expect_equal(subset(VEL_data, BroodID == "2009_endy_035_02_06")$ClutchType_calculated, "replacement")
  #Check laying date is as expected (2009-06-02)
  expect_equal(subset(VEL_data, BroodID == "2009_endy_035_02_06")$LayDate_observed, as.Date("2009-06-02"))
  #Check clutch size, brood size, and number fledged is as expected (2, NA, NA)
  expect_equal(subset(VEL_data, BroodID == "2009_endy_035_02_06")$ClutchSize_observed, 5)
  expect_equal(subset(VEL_data, BroodID == "2009_endy_035_02_06")$BroodSize_observed, 5)
  expect_equal(subset(VEL_data, BroodID == "2009_endy_035_02_06")$NumberFledged_observed, 3)
  #AvgChickMass and AvgTarsus should be NA, there were no chicks measured
  expect_equal(subset(VEL_data, BroodID == "2009_endy_035_02_06")$AvgChickMass, NA_real_)
  expect_equal(subset(VEL_data, BroodID == "2009_endy_035_02_06")$AvgTarsus, NA_real_)

  #Test 7: Tit brood where clutch type = replacement (due to past cutoff)
  #BroodID 1998_027_05_06 should be FICALB
  expect_equal(subset(VEL_data, BroodID == "1998_tri_027_05_06")$Species, "FICALB")
  #BroodID 1998_027_05_06 should have clutch type calculated 'replacement'
  expect_equal(subset(VEL_data, BroodID == "1998_tri_027_05_06")$ClutchType_calculated, "replacement")
  #Check laying date is as expected (1998-06-05)
  expect_equal(subset(VEL_data, BroodID == "1998_tri_027_05_06")$LayDate_observed, as.Date("1998-06-05"))
  #Check clutch size, brood size, and number fledged is as expected (3, 3, 0)
  expect_equal(subset(VEL_data, BroodID == "1998_tri_027_05_06")$ClutchSize_observed, 3)
  expect_equal(subset(VEL_data, BroodID == "1998_tri_027_05_06")$BroodSize_observed, 3)
  expect_equal(subset(VEL_data, BroodID == "1998_tri_027_05_06")$NumberFledged_observed, 0)
  #AvgChickMass and AvgTarsus should be NA, there were no chicks measured
  expect_equal(subset(VEL_data, BroodID == "1998_tri_027_05_06")$AvgChickMass, NA_real_)
  expect_equal(subset(VEL_data, BroodID == "1998_tri_027_05_06")$AvgTarsus, NA_real_)

  #Test 8: Flycatcher brood where clutch type = second
  #BroodID 2010_026_23_05 should be PARMAJ
  expect_equal(subset(VEL_data, BroodID == "2010_endy_026_23_05")$Species, "FICALB")
  #BroodID 2010_026_23_05 should have clutch type calculated 'second'
  expect_equal(subset(VEL_data, BroodID == "2010_endy_026_23_05")$ClutchType_calculated, "second")
  #Check laying date is as expected (2013-04-27)
  expect_equal(subset(VEL_data, BroodID == "2010_endy_026_23_05")$LayDate_observed, as.Date("2010-05-23"))
  #Check clutch size, brood size, and number fledged is as expected (4, 4, 4)
  expect_equal(subset(VEL_data, BroodID == "2010_endy_026_23_05")$ClutchSize_observed, 4)
  expect_equal(subset(VEL_data, BroodID == "2010_endy_026_23_05")$BroodSize_observed, 4)
  expect_equal(subset(VEL_data, BroodID == "2010_endy_026_23_05")$NumberFledged_observed, 4)
  #AvgChickMass and AvgTarsus should be NA, there were no chicks measured
  expect_equal(subset(VEL_data, BroodID == "2010_endy_026_23_05")$AvgChickMass, NA_real_)
  expect_equal(subset(VEL_data, BroodID == "2010_endy_026_23_05")$AvgTarsus, NA_real_)

  #Test 9: Flycatcher brood where chick measurements were taken
  #BroodID 2000_021_08_05 should be PARMAJ
  expect_equal(subset(VEL_data, BroodID == "2000_jedna_021_08_05")$Species, "FICALB")
  #BroodID 2000_021_08_05 should have clutch type calculated 'first'
  expect_equal(subset(VEL_data, BroodID == "2000_jedna_021_08_05")$ClutchType_calculated, "first")
  #Check laying date is as expected (2010-05-08)
  expect_equal(subset(VEL_data, BroodID == "2000_jedna_021_08_05")$LayDate_observed, as.Date("2000-05-08"))
  #Check clutch size, brood size, and number fledged is as expected (5, 5, 5)
  expect_equal(subset(VEL_data, BroodID == "2000_jedna_021_08_05")$ClutchSize_observed, 5)
  expect_equal(subset(VEL_data, BroodID == "2000_jedna_021_08_05")$BroodSize_observed, 5)
  expect_equal(subset(VEL_data, BroodID == "2000_jedna_021_08_05")$NumberFledged_observed, 5)
  #AvgChickMass and AvgTarsus should be NA, there were no chicks measured
  ...
  expect_equal(subset(VEL_data, BroodID == "1999_jedna_005_18_04")$LayDate_observed, as.Date("1999-04-18"))
  ## TODO: Need to ask how we deal with uncertainty!
  # expect_equal(subset(VEL_data, BroodID == "1999_jedna_005_18_04")$LayDate_observed, 6L)
  #Check clutch size, brood size, and number fledged is as expected
  expect_equal(subset(VEL_data, BroodID == "1999_jedna_005_18_04")$ClutchSize_observed, 9L)
  expect_equal(subset(VEL_data, BroodID == "1999_jedna_005_18_04")$BroodSize_observed, NA_integer_)
  expect_equal(subset(VEL_data, BroodID == "1999_jedna_005_18_04")$NumberFledged_observed, 7L)
  #AvgChickMass and AvgTarsus should be NA, there were no chicks measured
  ...
  #Check laying date is as expected (2013-04-27)
  expect_equal(subset(VEL_data, BroodID == "2002_karel_080_NA_NA")$LayDate_observed, as.Date(NA))
  #Check clutch size, brood size, and number fledged is as expected
  expect_equal(subset(VEL_data, BroodID == "2002_karel_080_NA_NA")$ClutchSize_observed, 3)
  expect_equal(subset(VEL_data, BroodID == "2002_karel_080_NA_NA")$BroodSize_observed, NA_integer_)
  expect_equal(subset(VEL_data, BroodID == "2002_karel_080_NA_NA")$NumberFledged_observed, 0)
  #AvgChickMass and AvgTarsus should be NA, there were no chicks measured
...
test_that("Location_data returns an expected outcome...", {
  ...
  expect_equal(subset(VEL_data, LocationID == "B1")$HabitatType, "deciduous")
  ...
  #Habitat is as expected
  expect_equal(subset(VEL_data, LocationID == "E9")$HabitatType, "evergreen")
  #Latitude and Longitude are as expected
  #We use 3 decimal places to clearly distinguish close nest boxes
  ...
  #Habitat is as expected
  expect_equal(subset(VEL_data, LocationID == "T2")$HabitatType, "evergreen")
  #Latitude and longitude are as expected
...
test_that("ID columns match the expected format for the pipeline", {
  ...
  test_ID_format(pipeline_output, column = "FemaleID", format = "^[:alpha:]{1,2}[:digit:]{3,6}$")

  ## MaleID format is as expected
  test_ID_format(pipeline_output, column = "MaleID", format = "^[:alpha:]{1,2}[:digit:]{3,6}$")

  ## IndvID format in Capture data  is as expected
  test_ID_format(pipeline_output, column = "IndvID", table = "Capture", format = "^[:alpha:]{1,2}[:digit:]{3,6}$")

  ## IndvID format in Individual data is as expected
  test_ID_format(pipeline_output, column = "IndvID", table = "Individual", format = "^[:alpha:]{1,2}[:digit:]{3,6}$")
