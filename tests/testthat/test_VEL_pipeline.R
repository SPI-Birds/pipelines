...
test_that("Brood_data returns an expected outcome...", {
  ...
  expect_equal(subset(VEL_data, BroodID == "2001_tri_006_20_04")$LayDate, as.Date("2001-04-20"))
  #Check clutch size, brood size, and number fledged is as expected (11, NA, 11)
  expect_equal(subset(VEL_data, BroodID == "2001_tri_006_20_04")$ClutchSize, 11)
  expect_equal(subset(VEL_data, BroodID == "2001_tri_006_20_04")$BroodSize, NA_integer_)
  expect_equal(subset(VEL_data, BroodID == "2001_tri_006_20_04")$NumberFledged, 11)
  ...
  expect_equal(subset(VEL_data, BroodID == "2013_zmola_004_14_06")$LayDate, as.Date("2013-06-14"))
  #Check clutch size, brood size, and number fledged is as expected (2, NA, NA)
  expect_equal(subset(VEL_data, BroodID == "2013_zmola_004_14_06")$ClutchSize, 2)
  expect_equal(subset(VEL_data, BroodID == "2013_zmola_004_14_06")$BroodSize, NA_integer_)
  expect_equal(subset(VEL_data, BroodID == "2013_zmola_004_14_06")$NumberFledged, NA_integer_)
  #AvgChickMass and AvgTarsus should be NA, there were no chicks measured
  ...
  expect_equal(subset(VEL_data, BroodID == "2013_sluka_104_24_06")$LayDate, as.Date("2013-06-24"))
  #Check clutch size, brood size, and number fledged is as expected (11, NA, 11)
  expect_equal(subset(VEL_data, BroodID == "2013_sluka_104_24_06")$ClutchSize, 11)
  expect_equal(subset(VEL_data, BroodID == "2013_sluka_104_24_06")$BroodSize, NA_integer_)
  expect_equal(subset(VEL_data, BroodID == "2013_sluka_104_24_06")$NumberFledged, 11)
  #AvgChickMass and AvgTarsus should be NA, there were no chicks measured
  ...
  expect_equal(subset(VEL_data, BroodID == "2013_duby_043_27_04")$LayDate, as.Date("2013-04-27"))
  #Check clutch size, brood size, and number fledged is as expected (10, NA, 10)
  expect_equal(subset(VEL_data, BroodID == "2013_duby_043_27_04")$ClutchSize, 10)
  expect_equal(subset(VEL_data, BroodID == "2013_duby_043_27_04")$BroodSize, NA_integer_)
  expect_equal(subset(VEL_data, BroodID == "2013_duby_043_27_04")$NumberFledged, 10)
  #AvgChickMass and AvgTarsus should be NA, there were no chicks measured
  ...
  expect_equal(subset(VEL_data, BroodID == "2009_endy_053_07_05")$LayDate, as.Date("2009-05-07"))
  #Check clutch size, brood size, and number fledged is as expected (11, NA, 11)
  expect_equal(subset(VEL_data, BroodID == "2009_endy_053_07_05")$ClutchSize, 6)
  expect_equal(subset(VEL_data, BroodID == "2009_endy_053_07_05")$BroodSize, 0)
  expect_equal(subset(VEL_data, BroodID == "2009_endy_053_07_05")$NumberFledged, 0)
  #AvgChickMass and AvgTarsus should be NA, there were no chicks measured
  ...
  expect_equal(subset(VEL_data, BroodID == "2009_endy_035_02_06")$LayDate, as.Date("2009-06-02"))
  #Check clutch size, brood size, and number fledged is as expected (2, NA, NA)
  expect_equal(subset(VEL_data, BroodID == "2009_endy_035_02_06")$ClutchSize, 5)
  expect_equal(subset(VEL_data, BroodID == "2009_endy_035_02_06")$BroodSize, 5)
  expect_equal(subset(VEL_data, BroodID == "2009_endy_035_02_06")$NumberFledged, 3)
  #AvgChickMass and AvgTarsus should be NA, there were no chicks measured
  ...
  expect_equal(subset(VEL_data, BroodID == "1998_tri_027_05_06")$LayDate, as.Date("1998-06-05"))
  #Check clutch size, brood size, and number fledged is as expected (3, 3, 0)
  expect_equal(subset(VEL_data, BroodID == "1998_tri_027_05_06")$ClutchSize, 3)
  expect_equal(subset(VEL_data, BroodID == "1998_tri_027_05_06")$BroodSize, 3)
  expect_equal(subset(VEL_data, BroodID == "1998_tri_027_05_06")$NumberFledged, 0)
  #AvgChickMass and AvgTarsus should be NA, there were no chicks measured
  ...
  #Check laying date is as expected (2013-04-27)
  expect_equal(subset(VEL_data, BroodID == "2010_endy_026_23_05")$LayDate, as.Date("2010-05-23"))
  #Check clutch size, brood size, and number fledged is as expected (4, 4, 4)
  expect_equal(subset(VEL_data, BroodID == "2010_endy_026_23_05")$ClutchSize, 4)
  expect_equal(subset(VEL_data, BroodID == "2010_endy_026_23_05")$BroodSize, 4)
  expect_equal(subset(VEL_data, BroodID == "2010_endy_026_23_05")$NumberFledged, 4)
  #AvgChickMass and AvgTarsus should be NA, there were no chicks measured
  ...
  expect_equal(subset(VEL_data, BroodID == "2000_jedna_021_08_05")$LayDate, as.Date("2000-05-08"))
  #Check clutch size, brood size, and number fledged is as expected (5, 5, 5)
  expect_equal(subset(VEL_data, BroodID == "2000_jedna_021_08_05")$ClutchSize, 5)
  expect_equal(subset(VEL_data, BroodID == "2000_jedna_021_08_05")$BroodSize, 5)
  expect_equal(subset(VEL_data, BroodID == "2000_jedna_021_08_05")$NumberFledged, 5)
  #AvgChickMass and AvgTarsus should be NA, there were no chicks measured
