...
#
#   check <- check_format_individual(VEL_data)
#
...
#   check <- compare_clutch_brood(VEL_data)
#
#   expect_false(check$check_list$Error)
#
#   browser()
...
#   check <- compare_brood_fledglings(VEL_data)
#
#   expect_false(check$check_list$Error)
#
#   if(check$check_list$Error == TRUE){
...
#   check <- compare_laying_hatching(VEL_data)
#
#   expect_false(check$check_list$Error)
#
#   if(check$check_list$Error == TRUE){
...
#   check <- compare_hatching_fledging(VEL_data)
#
#   expect_false(check$check_list$Error)
#
#   if(check$check_list$Error == TRUE){
