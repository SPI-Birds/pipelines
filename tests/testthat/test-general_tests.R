...
pipeline_output <- tibble::lst(Brood_data = brood_data_template,
...
pipeline_output_incorrect <- tibble::lst(Brood_data = tibble::tibble(BroodID = c(1,1,NA),
                                                                     PopID = NA,
                                                                     BreedingSeason = NA,
                                                                     Species = NA,
...
testthat::test_that("Column class test function works", {
  ...
  testthat::expect_error(test_col_classes(pipeline_output_incorrect, "Brood"))
  testthat::expect_error(test_col_classes(pipeline_output_incorrect, "Capture"))
  testthat::expect_error(test_col_classes(pipeline_output_incorrect, "Individual"))
  testthat::expect_error(test_col_classes(pipeline_output_incorrect, "Location"))

})


testthat::test_that("Column present test function works", {
  ...
  ## Should be errors. These fail because the number of columns are not the same.
  testthat::expect_error(test_col_present(pipeline_output_incorrect, "Brood"))
  testthat::expect_error(test_col_present(pipeline_output_incorrect, "Capture"))
  testthat::expect_error(test_col_present(pipeline_output_incorrect, "Individual"))
  testthat::expect_error(test_col_present(pipeline_output_incorrect, "Location"))
...
testthat::test_that("ID columns match the expected format for the pipeline", {
  ...
  testthat::expect_error(test_ID_format(pipeline_output, ID_col = "MaleID", ID_format = "^[:digit:]+$"))
  testthat::expect_error(test_ID_format(pipeline_output, ID_col = "FemaleID", ID_format = "^[:alpha:]+$"))
  testthat::expect_error(test_ID_format(pipeline_output, ID_col = "C-IndvID", ID_format = "^[:alpha:]+$"))
  testthat::expect_error(test_ID_format(pipeline_output, ID_col = "I-IndvID", ID_format = "^[:digit:]+$"))
...
testthat::test_that("Key columns only contain unique values", {
  ...
  testthat::expect_error(test_unique_values(pipeline_output_incorrect, "BroodID"))
  testthat::expect_error(test_unique_values(pipeline_output_incorrect, "Capture"))
  testthat::expect_error(test_unique_values(pipeline_output_incorrect, "Individual"))
...
testthat::test_that("Key columns in each table do not have NAs", {
  ...
  testthat::expect_error(test_NA_columns(pipeline_output_incorrect, "BroodID"))
  testthat::expect_error(test_NA_columns(pipeline_output_incorrect, "Capture"))
  testthat::expect_error(test_NA_columns(pipeline_output_incorrect, "Individual"))
...
testthat::test_that("Categorical columns do not have unexpected values", {
  ...
  testthat::expect_error(test_category_columns(pipeline_output_incorrect, "Brood"))
  testthat::expect_error(test_category_columns(pipeline_output_incorrect, "Capture"))
  testthat::expect_error(test_category_columns(pipeline_output_incorrect, "Individual"))
  testthat::expect_error(test_category_columns(pipeline_output_incorrect, "Location"))
