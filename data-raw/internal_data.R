...
data_templates <- tibble::lst(v1.0.0, v1.1.0, v2.0.0)
...
key_variables <- tibble::lst(
  ...
  Individual_data = c("IndvID", "Species", "PopID", "RingSeason", # v1.0 & v1.1 variables
                      "row", "individualID", "studyID", "siteID"), # v2.0 variables

  # Brood data
  Brood_data = c("BroodID", "PopID", "BreedingSeason", "Species", # v1.0 & v1.1 variables
                 "row", "broodID", "siteID", "studyID"), # v2.0 variables
  ...
  Capture_data = c("IndvID", "Species", "BreedingSeason", "CaptureDate", "CapturePopID", # v1.0 variables
                   ...
                   "row", "captureID", "individualID", "releaseTagID", "studyID", # v2.0 variables
  ...
  Location_data = c("LocationID", "LocationType", "PopID", # v1.0 & v1.1 variables
                    "row", "locationID", "locationType", "studyID", "siteID"), # v2.0 variables
...
categorical_variables <- tibble::lst(
  ...
  Individual_data = tibble::lst(
    ...
    speciesID = species_codes$scientificName, # v2.0
    siteID = pop_codes$PopID, # v2.0
    tagStage = c("chick", "subadult", "adult", NA), # v2.0
    tagSiteID = pop_codes$PopID, # v2.0
    geneticSex = c("F", "M", "C", NA) # v2.0
    #TODO: Maybe add studyID
  ),
  ...
  Capture_data = tibble::lst(
    ...
    captureSiteID = pop_codes$PopID, # v2.0
    releaseSiteID = c(pop_codes$PopID, NA) # v2.0
    #TODO: Maybe add studyID
  ),
  ...
  Measurement_data = tibble::lst( # v2.0
    siteID = pop_codes$PopID,
    measurementSubject = c("capture", "location")
    #TODO: Maybe add studyID
    #TODO: Maybe add measurementType?
  ),
...
save(data_templates, key_variables, utility_variables, categorical_variables,
