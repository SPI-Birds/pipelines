...
# Create list of optional variables generated by standard utility functions
utility_variables <- tibble::lst(

  # Individual data
  Individual_data = c("calculatedSex"),

  # Brood data
  Brood_data = c("breedingSeason", "calculatedClutchType", "nestAttemptNumber"),

  # Capture data
  Capture_data = c("exactAge", "minimumAge")
