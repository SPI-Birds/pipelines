...
#'@param species Species of interest. The 6-letter code of species as listed in the \href{https://github.com/SPI-Birds/documentation/blob/master/standard_protocol/SPI_Birds_Appendices.pdf}{Appendices} to the standard format. If blank all species are returned.
#'@param study The unique code of the field study as listed in the \href{https://github.com/SPI-Birds/documentation/blob/master/standard_protocol/SPI_Birds_Appendices.pdf}{Appendices} to the standard format. If blank all studies are returned.
#'@param optional_variables Optional variables (generated by standard utility functions) to be included in the pipeline output. Either a character vector of variable names or 'all' (if all optional variables should be included).
