...
#'@param species Species of interest. The 6-letter code of species as listed in the \href{https://github.com/SPI-Birds/documentation/blob/master/standard_protocol/SPI_Birds_Appendices.pdf}{Appendices} to the standard format. If blank will return all major species.
#'@param site The 3-letter code of the study site as listed in the \href{https://github.com/SPI-Birds/documentation/blob/master/standard_protocol/SPI_Birds_Appendices.pdf}{Appendices} to the standard format. For data owners with multiple study sites (e.g., NIOO, UAN) where a single pipeline is used for many study sites, this argument is used to extract data from individual study sites. For other pipelines that contain only one study site this argument can be ignored.
