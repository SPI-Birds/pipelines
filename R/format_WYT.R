...
#'  interest as listed in the
#'  \href{https://github.com/SPI-Birds/documentation/blob/master/standard_protocol/SPI_Birds_Protocol_v1.1.0.pdf}{standard
#'  protocol}.
#'
  ...
  Chick_captures_old <- Chick_captures_old %>%
    ...
    dplyr::mutate(
      ...
      BreedingSeason = dplyr::case_when(
        is.na(.data$CaptureDate) ~ as.integer(
