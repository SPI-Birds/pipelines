...
#'   \item Rows 5-10 are records that are used to test the functionality of check 'B9: Comparing parent species' (see \code{\link{compare_species_parents}}). The records are parents of the same or different species than recorded in Brood_data.
#'   \item Rows 11-988 are records that are used to test the functionality of checks 'C1a-b: Checking capture variable values against reference values' (see \code{\link{check_values_capture}}). The records are adults and chicks with probable, unlikely and impossible values in Mass (C1a) and Tarsus (C1b).
#'   \item Rows 989-990 are records that are used to test the functionality of check 'C2: Checking chick age values' (see \code{\link{check_chick_age}}). The records are a chick with a correct chick age, and a chick with an incorrect chick age.
#'   \item Rows 991-995 are records that are used to test the functionality of check 'I1: Checking unique individual IDs' (see \code{\link{check_unique_IndvID}}). The records are individuals with IDs that are unique, duplicated among populations and duplicated within populations.
#'   \item Rows 996-997 are records that are used to test the functionality of check 'I2: Checking that chicks have BroodIDs' (see \code{\link{check_BroodID_chicks}}). The records are a chick with a BroodID, and a chick without a BroodID.
#'   \item Rows 998-999 are records that are used to test the functionality of check 'I3: Checking that individuals have no conflicting sex' (see \code{\link{check_conflicting_sex}}). The records are an individual with certain sex, and an individual with uncertain sex (i.e. recorded as both male and female).
#'   \item Rows 1000-1001 are records that are used to test the functionality of check 'I4:Checking that individuals have no conflicting species' (see \code{\link{check_conflicting_species}}). The records are an individual with certain species, and an individual with uncertain species (i.e. recorded as two different species).
#'   \item Row 1002 is a record that is used to test the functionality of check 'I5: Checking that individuals in Individual_data also appear in Capture_data' (see \code{\link{check_individuals_captures}}). The record is an individual that is also recorded in Individual_data.
#'   \item Rows 1003-1005 are records that are used to test the functionality of check 'C3: Checking that adults caught on nest are listed are the parents' (see \code{\link{check_adult_parent_nest}}). The records are a parent caught on a nest and marked as the parent of that brood, a parent caught in a mist net, and a parent caught on a nest but not marked as the parent of that brood.
...
#'   \item Rows 1-4 are records that are used to test the functionality of check 'B6: Comparing brood size with number of chicks captured' (see \code{\link{compare_broodsize_chicknumber}}). The records are chicks in equal, smaller or larger number than recorded as brood size in Brood_data.
#'   \item Rows 5-10 are records that are used to test the functionality of check 'B9: Comparing parent species' (see \code{\link{compare_species_parents}}). The records are parents of the same or different species than recorded in Brood_data.
#'   \item Rows 11-13 are records that are used to test the functionality of check 'I1: Checking unique individual IDs' (see \code{\link{check_unique_IndvID}}). The records are individuals with IDs that are unique, duplicated among populations and duplicated within populations.
#'   \item Rows 14-15 are records that are used to test the functionality of check 'I2: Checking that chicks have BroodIDs' (see \code{\link{check_BroodID_chicks}}). The records are a chick with a BroodID, and a chick without a BroodID.
#'   \item Rows 16-17 are records that are used to test the functionality of check 'I3: Checking that individuals have no conflicting sex' (see \code{\link{check_conflicting_sex}}). The records are an individual with certain sex, and an individual with uncertain sex (i.e. recorded as both male and female).
#'   \item Rows 18-19 are records that are used to test the functionality of check 'I4: Checking that individuals have no conflicting species' (see \code{\link{check_conflicting_species}}). The records are an individual with certain species, and an individual with uncertain species (i.e. recorded as two different species).
#'   \item Rows 20-21 are records that are used to test the functionality of check 'I5: Checking that individuals in Individual_data also appear in Capture_data' (see \code{\link{check_individuals_captures}}). The records are an individual that is also recorded in Capture_data, and an individual that is missing from Capture_data.
#'   \item Rows 22-27 are records that are used to test the functionality of check 'B10: Comparing species of brood and of parents' (see \code{\link{compare_species_brood_parents}}). The records are parents of the same species as their brood, and parents of different species than their brood.
#'   \item Rows 28-33 are records that are used to test the functionality of check 'B11: Comparing species of brood and of chicks' (see \code{\link{compare_species_brood_chicks}}). The records are chicks of the same species as the brood they are in, and chicks of different species than the brood they are in.
