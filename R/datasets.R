...
#'   \item Rows 1140-1141 are records that are used to test the functionality of check 'L2: Checking that locations in Location_data appear in other data tables' (see \code{\link{check_locations_brood_capture}}). The records are a location that appears in both Capture_data and Brood_data, and one that only appears in Capture_data.
#'   \item Rows 1142-1143 are records that are used to test the functionality of check 'C5: Checking that individuals in Capture_data also appear in Individual_data' (see \code{\link{check_captures_individuals}}). The records are an individual that is also recorded in Individual_data, and one that is missing from Individual_data.
#'   \item Rows 11144-1147 are records that are used to test the functionality of check 'B14: Checking that parents appear in Capture_data' (see \code{\link{check_parents_captures}}). The records are parents of broods where either none or one parent is missing.
#'   \item Rows 1148-1151 are records that used to test the functionality of check 'B15: Checking that nest locations appear in Location_data' (see \code{\link{check_brood_locations}}). The records are the parents of the broods, caught on locations that appear or do not appear in Location_data.
#'   \item Rows 1152-1153 are records that used to test the functionality of check 'C6: Checking that capture locations appear in Location_data' (see \code{\link{check_capture_locations}}). The records are captures on a location that does appear in Location_data, and on a location that does not appear in Location_data.
#' }
#'
...
#'   \item Rows 1137-1138 are records that are used to test the functionality of check 'L2: Checking that locations in Location_data appear in other data tables' (see \code{\link{check_locations_brood_capture}}). The records are a location that appears in both Capture_data and Brood_data, and one that only appears in Capture_data.
#'   \item Rows 1139 is a record that is used to test the functionality of check 'C5: Checking that individuals in Capture_data also appear in Individual_data' (see \code{\link{check_captures_individuals}}). The record is an individual that is also recorded in Capture_data.
#'   \item Rows 1140-1143 are records that are used to test the functionality of check 'B14: Checking that parents appear in Capture_data' (see \code{\link{check_parents_captures}}). The records are parents of broods where either none or one parent is missing.
#'   \item Rows 1144-1147 are records that used to test the functionality of check 'B15: Checking that nest locations appear in Location_data' (see \code{\link{check_brood_locations}}). The records are the parents of the broods, caught on locations that appear or do not appear in Location_data.
#'   \item Rows 1148-1149 are records that are used to test the functionality of check 'C6: Checking that capture locations appear in Location_data' (see \code{\link{check_capture_locations}}). The records are individuals captured on locations that do and do not appear in Location_data.
#' }
#'
...
#'   \item Rows 6-107 are records that are used to test the functionality of check 'L1: Checking location coordinates' (see \code{\link{check_coordinates}}). The records are capture locations within 15 km of study site centre point and one capture locations farther away.
