...
format_GLA <- function(db = choose_directory(),
  ...
  nest_data <- readxl::read_xlsx(path = paste0(db, "/GLA_PrimaryData_Nest.xlsx"),
    ...
    dplyr::mutate(ClutchSize_max = dplyr::case_when(.data$ClutchComplete == "TRUE" ~ as.numeric(.data$ClutchSize),
                  ...
                  Species = dplyr::case_when(.data$Species == "greti" ~ species_codes[species_codes$speciesEURINGCode == 14640,]$speciesID,
                                             .data$Species == "bluti" ~ species_codes[species_codes$speciesEURINGCode == 14620,]$speciesID,
                                             ...
                                             .data$Species == "tresp" ~ species_codes[species_codes$speciesEURINGCode == 15980,]$speciesID),
