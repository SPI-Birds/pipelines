...
#' @param optional_variables Optional variables to be included in the pipeline output. Either a list of variable names or 'all' (if all optional variables should be included). See Details for a full list of optional variables.
