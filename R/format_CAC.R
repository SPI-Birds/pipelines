...
format_CAC <- function(db = choose_directory(),
  ...
  nest_data <- readxl::read_xlsx(path = paste0(db, "/CAC_PrimaryData_Nest.xlsx"), guess = 5000) %>%
  ...
  rr_data <- readxl::read_xlsx(path = paste0(db, "/CAC_PrimaryData_RingingRecords.xlsx"),
  ...
  Brood_data <- create_brood_CAC(nest_data, rr_data)

  #### CAPTURE DATA
  message("Compiling capture information...")
  Capture_data <- create_capture_CAC(nest_data, rr_data)

  #### INDIVIDUAL DATA
  message("Compiling individual information...")
  Individual_data <- create_individual_CAC(Capture_data, Brood_data)

  #### LOCATION DATA
  message("Compiling location information...")
  Location_data <- create_location_CAC(nest_data, rr_data)
...
#'
#' @param rr_data Data frame of ringing records from Can Cata, Spain.
#'
#' @return A data frame.

create_brood_CAC <- function(nest_data, rr_data) {
...
create_capture_CAC <- function(nest_data, rr_data) {
...
#'
#' @param Brood_data Brood data output from Can Cata, Spain
#'
#' @return A data frame.

create_individual_CAC <- function(Capture_data, Brood_data){
