...
format_KIL <- function(db = choose_directory(),
  ...
  brood_data_til92 <-
    ...
    dplyr::mutate(Species = species_codes[which(species_codes$speciesEURINGCode == 14640), ]$speciesID,
                  PopID   = "KIL",
  ...
  adults_data_til92 <-
    ...
    dplyr::mutate(IndvID  = as.character(.data$AdultId),
                  Species = species_codes[which(species_codes$speciesEURINGCode == 14640), ]$speciesID,
                  PopID   = "KIL",
