...
create_brood_HAR <- function(db, species_filter){
  ...
  Brood_data <- extract_paradox_db(path = db, file_name = "HAR_Pesat.DB") %>%
...
create_nestling_HAR <- function(db, Brood_data){
  ...
  Nestling_data <- extract_paradox_db(path = db, file_name = "HAR_Pullit.DB") %>%
...
create_capture_HAR <- function(db, Brood_data, species_filter, return_errors){
  ...
  Capture_data <- extract_paradox_db(path = db, file_name = "HAR_Rengas.DB") %>%
...
create_location_HAR <- function(db, protocol_version){
  ...
  Location_data <- extract_paradox_db(path = db, file_name = "HAR_Paikat.DB") %>%
